        ...
        <div class="row justify-content-center">
            ...
            <div class="card">
                <div class="card-header">    
                		 ...
                		 <div class="col-sm-9">
                		 	   <button style="border: none;" id="add" class="btn  btn-primary float-right"><i class="fas fa-plus"></i>  </button>
                		 </div>
                		 </div>
						...
						<c:when test="${size >=3 }">
                            ...
                            <div class="card card-success">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        <img style="height: 250px;" src="${cssroot}/image/${x.image}" width="100%"
                                    ...
                                    <p class="text-muted">
                                        <span class="tag tag-danger"> ${x.booking_Fee} % For Onetime </span>
